...
ocr = PaddleOCR(use_space_char=True, warmup=False, use_gpu=False, use_tensorrt=False, use_angle_cls=False,
                rec_batch_num=1, cpu_threads=10, ocr_version="PP-OCRv3",
