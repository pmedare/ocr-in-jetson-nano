...
ocr = PaddleOCR(lang='en', ocr_version='PP-OCRv2', use_gpu=True, use_tensorrt=True, use_angle_cls=False, 
                rec_batch_num=1, cpu_threads=4, layout=False, table=False, use_visual_backbone=False, 
                enable_mkldnn=False, gpu_mem=1000, det_db_unclip_ratio=0.5, warmup=True,
...
image = cv2.resize(cv2.imread("/home/jetson/tfg/data/cropped_images/1103.jpg"), (224, 224))
for i in range(35):
...
with open('/home/jetson/tfg/raw_runs/logs/paddleOCR_jetson_GPU_trt_fp32_v2_224.txt', 'w') as file:
    counter=0
