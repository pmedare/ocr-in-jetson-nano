...
ocr = PaddleOCR(lang='en', use_gpu=True, use_angle_cls=False)
...
with open('/mnt/DADES/home/pmedina/tfg/src/raw_runs/logs/paddleOCR_server_GPU.txt', 'w') as file:
...
print(f"Average seconds for image: {round(global_time/i*1000, 3)}ms.")